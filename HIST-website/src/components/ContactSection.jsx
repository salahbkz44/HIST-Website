    ...
    <>
      ...
      >
        <div className="relative flex md:flex-row flex-col    overflow-hidden">
          ...
          <div className="w-full md:!px-0 !px-10 flex flex-col items-start justify-center text-white">
            {/* Logo */}
            <div className="mb-6">
          ...
          <div className="md:w-1/3 md:!pt-8 !pt-5 md:!px-0 !px-10 text-black flex flex-col justify-start">
            ...
            <div className="flex items-start justify-center gap-2 !mt-9">
          ...
          <div className="md:w-1/3 w-full md:-ml-[10%] overflow-hidden">
            <a href="https://maps.app.goo.gl/FWFvgwpVAugCRhY58">
              <img
                src={MapsPic}
                alt=""
                className="w-full clip-mobile md:clip-desktop"
              />
            </a>
          </div>
        </div>
